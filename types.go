...
type SuiteQLTransactions []SuiteQLTransaction

type SuiteQLTransaction struct {
	Links                     Links  `json:"links"`
...
func (s SuiteQLTransaction) MarshalJSON() ([]byte, error) {
	type Alias SuiteQLTransaction
	return MarshalCustomFields(Alias(s), s.CustomFields)
}

func (s *SuiteQLTransaction) UnmarshalJSON(data []byte) error {
	err := UnmarshalCustomFields(data, &s.CustomFields)
	if err != nil {
		return err
	}
